...
if(errors.length){console.error(`Rendered publication validation failed (${errors.length})\n- ${errors.join('\n- ')}`);process.exit(1);}console.log(`Rendered publication validation passed: ${files.length} articles, 4–5 figures each, substantive text, metadata, navigation, references, and 141 sitemap URLs.`);
