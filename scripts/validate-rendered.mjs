...
if(!familyCoverage.has('aws-architecture'))errors.push('AWS architecture family is not rendered');if(familyCoverage.size<12)errors.push(`expected at least 12 purposeful visual families, found ${familyCoverage.size}`);if(modes.size<8)errors.push(`expected all 8 publication modes, found ${modes.size}`);if(profiles.size<10)errors.push(`expected broad content-aware profile coverage, found ${profiles.size}`);
