...
export const issueExpansions: Record<string, IssueExpansion> = {
  '2026-01-maintenance-decision-brief': {
    operatingContext: [
      ...
      'The brief should therefore be assembled against an evidence contract. Required fields include aircraft and flight identity, event and ingestion time, configuration effective at the event, open and recent work, applicable source revisions, data-quality exceptions, and the role expected to disposition the case. A missing required field changes the state of the brief; it is not silently replaced by a plausible narrative.',
  ...
  '2026-03-chronic-defect-intelligence': {
    ...
    engineeringPractice: [
      'A controlled evaluation can begin with cases already adjudicated by reliability engineering. Reviewers reconstruct the event set without seeing the system grouping, then compare joins, omissions, and explanations. False joins and missed joins should be segmented by identity quality, text quality, configuration change, and outcome availability so improvement work targets the real weakness.',
  ...
  '2026-04-maintenance-knowledge-retrieval': {
    operatingContext: [
      ...
      'Corpus admission should therefore be a controlled process. The document record needs identity, owner, revision, effective and withdrawal dates, aircraft or component applicability, approval state, access classification, and structural relationships. Warnings, cautions, prerequisites, tables, and figures must remain connected to the procedural text they qualify.',
    ...
    engineeringPractice: [
      ...
      'A practical rollout starts with one controlled collection and one task such as locating applicable troubleshooting context. Technical publications, engineering, maintenance users, security, and records owners should review failures together. Generated synthesis remains advisory; approved data and organizational procedures continue to govern maintenance action.'
    ]
  },
  '2026-08-maintenance-observability': {
    ...
    engineeringPractice: [
      ...
      'Daily review can manage current exceptions while a weekly product-quality review examines trends, recurring corrections, and error-budget consumption. Significant incidents should improve the evidence contract, monitors, and fallback workflow—not merely produce a service restart. Retention and access controls must apply to traces because they can join sensitive operational and personnel activity.'
    ]
  },
  ...
  '2026-10-maintenance-ai-governance': {
    operatingContext: [
      ...
      'An intake record should name the intended decision, users, affected fleet or process, source authority, output destination, human review, prohibited uses, worst credible error, fallback, and owner. This creates a practical profile against which the organization can apply proportional evidence and approval requirements.',
  ...
  '2026-11-maintenance-outcome-learning': {
    operatingContext: [
      ...
      'This distinction protects evaluation from several biases. Cases receiving action are easier to observe than cases dismissed; removed components are more likely to receive shop findings than retained ones; and user feedback reflects usefulness and presentation as well as technical truth. Cohort reporting should show where labels are missing and how they were obtained.'
    ],
    engineeringPractice: [
  ...
  '2026-12-maintenance-intelligence-operating-system': {
    ...
    engineeringPractice: [
      'A practical roadmap delivers one or two decision products while establishing only the common capabilities they truly require. The team writes contracts at each boundary, retains source and transformation lineage, and proves that the displayed evidence can be reproduced. Subsequent products earn reuse by sharing those contracts rather than by being forced onto a universal workflow.',
